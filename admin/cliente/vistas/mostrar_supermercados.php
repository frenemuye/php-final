<?php
    if(!isset($listaSupermercado) || !isset($countSupermercado) ){
        header("Location: ../../../");
    }
?>
<!DOCTYPE html>
...
<body>
        ...
        <table class="table align-middle table-hover table-dark" border="0" align="center" cellpadding="7">
            <thead>
                <tr class="align-bottom" bgcolor="gray">
                    ...
                    <th scope="col" class="align-top">Cedula Supermercado</th>
                    <th scope="col" class="align-top">Nombre Supermercado</th>
                    <th scope="col" class="align-top">Contraseña Supermercado</th>
                    <th scope="col" class="align-top">Repita Contraseña</th>
                    <th scope="col" class="align-top">Tipo de Supermercado</th>

                    
                </tr>
            </thead>
            <tbody>
                <!--Obj lista de supermercados tiene la matriz de la consulta y mete la primera fila en obj. supermercado-->
                <?php foreach ($listaSupermercado as $supermercado) { ?>
                    <tr class="align-bottom">
                        <th scope="row" class="align-top"> <?php echo $supermercado->getCodCliente();     ?> </th>
                        <td class="align-top"> <?php echo $supermercado->getCedula(); ?> </td>
                        <td class="align-top"> <?php echo $supermercado->getNombre(); ?> </td>
                        <td class="align-top"> •••••••• </td>
                        <td class="align-top"> •••••••• </td>
                        <td class="align-top"> <?php echo $supermercado->getTipo(); ?> </td>                        
                    </tr>
                <?php }  ?>
            </tbody>
        </table>
            ...
            <thead>
                <tr class="align-bottom" bgcolor="gray">
                    <td colspan="8" align="center">
                        <!--Obj lista de supermercados tiene la matriz de la consulta y mete la primera fila en obj. supermercado-->
                        <strong> CANTIDAD DE SUPERMERCADOS </strong>
                    </td>
                </tr>
            </thead>
            <tbody>
                <tr class="align-bottom" bgcolor="gray">
                    <td colspan="8" align="center">
                        <!--Obj lista de supermercados tiene la matriz de la consulta y mete la primera fila en obj. supermercado-->
                        <?php echo "Cantidad de supermercados: " . $countSupermercado[0] . "."; ?>
                    </td>
                </tr>
                <tr class="align-bottom">
    ...
    <script type="text/javascript">
        function confirmar_borrar() {
            var respuesta = confirm("¿Estás seguro de querer eliminar este supermercado?");
            if (respuesta == true) {
                return true;
            } else {
                return false;

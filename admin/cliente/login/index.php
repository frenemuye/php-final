...
<head>
    ...
    <title>MODULO DE INGRESO - CLIENTES</title>
</head>
...
<body>
        ...
        <strong>
            <center>
                <div class="alert alert-primary" role="alert">
                    <h3>LOGIN BACKOFFICE CLIENTES</h3>
                </div>
    ...
    <form action="validar_ingreso.php" method="post">
        <div class="form-group">
            <label for="InputEmail">Cliente del sistema</label>
        ...
        <div class="form-group">
            <label for="InputType">Tipo de Cliente:</label>
            <select type="text" name="tipo" value="" class="custom-select">
                <option>Tendero</option>
                <option>Supermercado</option>
            </select>
            <br><br>
            <center><button type="submit" value="Ingresar" class="btn btn-warning">Ingresar</button></center>
    </form>
    <br><br>
    <center>
        <a href="../../../"><h5 align="center">Volver al sitio web</h5></a>
        <a href="../controlador_cliente.php?accion=registrar"><h5 align="center">Registrarme</h5></a>
    </center>

...
if (isset($_SESSION["nombre"]) && isset($_SESSION["tipo"])) {
    if ($_SESSION["tipo"] == "Tendero") {
        //echo "<center><b>BIENVENIDO SECCION DE PEDIDOS</b></center>";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/css_backoffice_pedido_tienda.css">
...
<body>
    <div id="contenedor1">
        <header>
            <h1 align="center">Tenderos</h1><br>
        </header>
        <ul>
